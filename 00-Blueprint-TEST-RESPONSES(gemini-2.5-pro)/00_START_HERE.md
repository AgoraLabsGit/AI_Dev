...
*   **Your Goal**: To decide on the technologies we will use to build the project.
*   **My Role**: I will provide a recommended, industry-standard stack (e.g., Next.js, TypeScript, Tailwind CSS). I will explain the pros and cons and help you make an informed decision based on our project's needs.

### **Step 4: Analyze for Migration (If Applicable)**
*   **Document**: `04-MIGRATION-ANALYSIS.md`
*   **Your Goal**: If we are migrating an existing project, this is where we'll analyze the code.
*   **My Role**: I will guide you on placing the code in the `Migration/` folder. I will then perform an automated analysis to identify reusable patterns, dependencies, and potential challenges, which we will document here. If this is a new project, we can skip this step.

### **Step 5: Identify Optimization Opportunities**
*   **Document**: `05-OPTIMIZATION-PROPOSAL.md`
*   **Your Goal**: To think ahead about performance, scalability, and maintainability.
