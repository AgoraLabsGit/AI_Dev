...
export function QuickActionButton({ 
  ...
  return (
    <button
      className={cn(
        'quick-action-btn inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 hover:shadow-md active:scale-95 border',
